            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3>Преимущества ( Вигідний курс )</h3>
                        <p>* - поля обязательные для заполнения</p>
                    </div>
                    <div class="card-body">
                        <form method="POST"
                              @if(isset($entry))
                              action="{{ route('admin.advantage.update', ['post' => $entry->id]) }}"
                              @else
                                ...
                                <div class="col-sm-8">
                                    <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade" id="ru" role="tabpanel" aria-labelledby="ru-tab"><br>
                                            ...
                                            <div class="form-group">
                                                <label>Описание преимущества *</label>
                                                <textarea name="description_ru" class="form-control" id="description" rows="5">
                                                @isset($entry)
                                    ...
                                    <div class="form-group">
                                        @isset($entry->image)
                                            <div class="card card-body bg-light col-sm-4">
                                                <img src="{{ asset('storage/images/advantage/'.$entry->image) }}" alt=""   class="img-fluid">
                                            </div>
                                        @endisset
                                    </div>
