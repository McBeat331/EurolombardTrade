    ...
    <div class="container-fluid">
        <div class="row page-titles mx-0">
                    ...
                    <div class="row page-titles mx-0">
                        <a href="{{ route('admin.pages.create') }}">
                            <button type="button" class="btn btn-primary">
                                ...
                                <span style="font-weight: bold">Добавить SEO</span>
                            </button>
                        </a>
                    </div>
                </div>
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">SEO страниц</a></li>
                </ol>
            </div>
        </div>
        <!-- row -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">SEO страниц</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table verticle-middle table-responsive-sm">
                                ...
                                @foreach($entries as $page)
                                    <tr>
                                        ...
                                        <td><span><a href="{{ route('admin.pages.edit',$page->id) }}" class="mr-4 btn btn-info" data-toggle="tooltip"
