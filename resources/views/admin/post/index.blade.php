        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>Здесь хранятся записи Блога</h4>
                    <span class="ml-1">Блог</span>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Блог</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Записи</a></li>
                </ol>
            </div>
        </div>
        <!-- row -->
